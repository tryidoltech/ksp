...
refreshCallbacks(),
    document.getElementById("showModal").addEventListener("show.bs.modal", function (e) {
        e.relatedTarget.classList.contains("edit-item-btn")
            ? ((document.getElementById("exampleModalLabel").innerHTML = "Edit Task"), (document.getElementById("showModal").querySelector(".modal-footer").style.display = "block"), (document.getElementById("add-btn").innerHTML = "Update"))
            ...
            : ((document.getElementById("exampleModalLabel").innerHTML = "List Task"), (document.getElementById("showModal").querySelector(".modal-footer").style.display = "none"));
    }),
        ...
        (Array.prototype.slice.call(forms).forEach(function (a) {
            a.addEventListener(
                ...
                function (e) {
                    ...
                    a.checkValidity()
                        ? (e.preventDefault(),
                          "" === projectNameField.value || "" === tasksTitleField.value || "" === clientNameField.value || "" === dateDueField.value || "" === priorityField.value || "" === statusField.value || editlist
                              ? "" !== projectNameField.value &&
                                ...
                                clearFields(),
                                tooltipElm(),
                                Swal.fire({ position: "center", icon: "success", title: "Task updated Successfully!", showConfirmButton: !1, timer: 2e3, showCloseButton: !0 }))
                              : (tasksList.add({
                                ...
                                tooltipElm(),
                                count++,
                                Swal.fire({ position: "center", icon: "success", title: "Task inserted successfully!", showConfirmButton: !1, timer: 2e3, showCloseButton: !0 })))
        ...
        editBtns &&
            Array.from(editBtns).forEach(function (e) {
                e.addEventListener("click", function (e) {
                    ...
                    Array.from(e).forEach(function (e) {
                        var t,
                            a = (isid = new DOMParser().parseFromString(e._values.id, "text/html")).body.firstElementChild.innerHTML;
                        a == itemId &&
                            ((editlist = !0),
                            (idField.value = a),
