...
var options,
    ...
    isApexSeriesData =
        (linechartcustomerColors &&
            ((options = {
                series: [
                    { name: "Sole Expense", type: "bar", data: [34, 65, 46, 68, 49, 61, 42, 44, 78, 52, 63, 67] },
                    { name: "Total Expense", type: "area", data: [89.25, 98.58, 68.74, 108.87, 77.54, 84.03, 51.24, 28.57, 92.57, 42.36, 88.51, 36.57] },
                    { name: "Trip Expense", type: "bar", data: [8, 12, 7, 17, 21, 11, 5, 9, 7, 29, 12, 35] },
                ],
