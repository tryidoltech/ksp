document.getElementById("sa-basic") &&
    ...
    document.getElementById("sa-params").addEventListener("click", function () {
        Swal.fire({
            ...
            t.value
                ? Swal.fire({ title: "Deleted!", text: "Your Data has been deleted.", icon: "success", confirmButtonClass: "btn btn-primary w-xs mt-2", buttonsStyling: !1 })
    ...
    document.getElementById("sa-position").addEventListener("click", function () {
        Swal.fire({ position: "top-center", icon: "success", title: "Timesheet has been Approved", showConfirmButton: !1, timer: 1500, showCloseButton: !0 });
    }),

    document.getElementById("sa-forward") &&
document.getElementById("sa-forward").addEventListener("click", function () {
        Swal.fire({ position: "top-center", icon: "success", title: "Your Task Has been Forwarded to next Week", showConfirmButton: !1, timer: 1500, showCloseButton: !0 });
    }),
    document.getElementById("sa-reject") &&
    document.getElementById("sa-reject").addEventListener("click", function () {
        Swal.fire({ position: "top-center", icon: "error", title: "Timesheet has been Rejected", showConfirmButton: !1, timer: 1500, showCloseButton: !0 });
    }),
    ...
    document.getElementById("custom-sa-warning").addEventListener("click", function () {
        Swal.fire({
            html:
                '<div class="mt-3"><lord-icon src="https://cdn.lordicon.com/gsqxdxog.json" trigger="loop" colors="primary:#f7b84b,secondary:#f06548" style="width:100px;height:100px"></lord-icon><div class="mt-4 pt-2 fs-15 mx-5"><h4>Are you Sure ?</h4><p class="text-muted mx-4 mb-0">You want to Delete ?</p></div></div>',
            showCancelButton: !0,
